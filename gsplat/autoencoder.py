# Autoencoder from Langsplat
# Has to define the encoder and decoder dims ourselves
# Langsplat uses encoder dims: [256, 128, 64, 32, 3]
# Langsplat used decoder dims: [16, 32, 64, 128, 256, 256, 512]
